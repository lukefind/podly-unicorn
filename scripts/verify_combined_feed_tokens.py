...
def fetch_combined_feed(port: str, token_id: str, token_secret: str, public_host: str = "") -> Optional[str]:
    ...
    Args:
        ...
        public_host: Public hostname to set in Host header (e.g., 'pod.lukus.cloud')
...
def main():
    ...
    parser.add_argument("--host", default="pod.lukus.cloud", help="Public hostname for Host header (default: pod.lukus.cloud)")
