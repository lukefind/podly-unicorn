...
Do NOT flag show sign-offs and outros as ads. Phrases like "we'll be back next week", "see you next time", host name roll-calls, and the show's own contact info are NOT ads.
