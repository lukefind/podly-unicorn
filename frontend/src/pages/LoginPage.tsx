...
export default function LoginPage() {
  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-5xl mx-auto px-4 py-8 flex flex-col md:flex-row gap-8 md:gap-12 items-center md:min-h-screen md:justify-center md:items-center">
        {/* Left side - Features */}
        <div className="w-full md:flex-1 text-center md:text-left flex flex-col justify-center">
          <div className="flex items-center justify-center md:justify-start gap-3 mb-6">
            ...
            <h1 className={`text-3xl md:text-4xl font-bold ${brandClass}`}>
              {brandName}
            </h1>
          </div>
        ...
        <div className="w-full max-w-md bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm shadow-xl rounded-2xl border border-purple-100 dark:border-purple-800 p-8 md:self-center">
          ...
          <div className="mt-6 pt-6 border-t border-purple-100 dark:border-purple-800">
            <div className="flex items-center justify-center gap-4 text-xs text-purple-400 dark:text-purple-500">
              <span>Next theme: {nextThemeLabel}</span>
              <span>•</span>
